...
void goToStart() {
    ...
    DMANow(3, startScreenTiles, &((charblock *)0x6000000)[0], 11584/2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 8672/2);
...
void goToGame() {
    ...
    DMANow(3, gameBackTiles, &((charblock *)0x6000000)[0], 33152/2);
...
void goToWin() {
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 15136/2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 17696/2);
